...
#define NET_MOUDLE_MASK_USER   0x0000010a  //控制台
...
#define NET_PACKTYPE_MCS_REQUEST_STREAM_TREE            0x0000051D  //quest stream tree data
#define NET_PACKTYPE_MCS_ADDMCSCENTOR_NODE              0x0000051E  //增加管理中心服务节点
...
#define NET_PACKTYPE_MCS_MODIFYGRP              0x00000604  //修改设备分组
#define NET_PACKTYPE_MCS_GETSERVERLISTINFO      0x00000700  //获取各个服务器信息


/***********************************************
*                   设备状态协议
************************************************/
#define DEVICE_STATUS_ONLINE                        0x00000a00
#define DEVICE_STATUS_OFFLINE                       0x00000a01
#define DEVICE_STATUS_ALARM                          0x00000a02
